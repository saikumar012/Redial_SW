...
<a href="agents_new.php" style="border:none;" class="active">Builders</a>
</div>
...
<div class="main_hed">Bulk > Builders  > <span>Add New</span> 
<div class="inner_menu"><a href="agents_new.php" class="active">Add New</a>|<a href="agents_existing.php">Add to Existing</a></div>
</div>
...
<table border="0" cellpadding="0" cellspacing="0" class="bulkGridView">
...
<p><li class="buttons" style="float:right;"><a href="agents_newpost.php"><input  type="submit" value="ADD" class="input_btn"/></a></li></p>
