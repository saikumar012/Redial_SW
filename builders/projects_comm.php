...
<div class="r_menu2">
<a href="properties2.php">Properties</a>
<a href="projects2.php" class="active"> Projects</a>
</div>


<div style="width:100%; float:left;">

<div class="main_hed">Bulk > Builders > Projects  > <span>Commercial</span> <div class="inner_menu"><a href="projects2.php">Residential</a>|<a href="projects_comm.php" class="active">Commercial</a>|<a href="agriculture3.php">Agriculture</a></div></div>
...
<p><li><label>Property Type <span class="star">*</span></label><select data-placeholder="Select Your Type" class="chzn-select" style="width:315px;" tabindex="4">
          <option value=""></option> 
...
<p><li><label style="width:150px;">POSSESION STATUS <span class="star">*</span></label><br /><br /><input type="radio" name="POSSESION" />Under Construction  <input type="radio" name="POSSESION" />Ready to Occupy</li></p>
...
<p><li class="buttons" style="float:right;"><a href="projects_comm_post.php"><input  type="submit" value="POST" class="input_btn"/></a></li></p>
