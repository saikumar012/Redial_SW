...
<div class="main_hed">Bulk > Builders > Projects > <span>Agriculture</span> <div class="inner_menu"><a href="projects2.php">Residential</a>|<a href="projects_comm.php">Commercial</a>|<a href="agriculture3.php" class="active">Agriculture</a></div></div>
...
<p><li><label>Description <span class="star">*</span></label><textarea class="textarea"></textarea><br /><span class="description_count" style="margin-right:105px;"> 125</span>
</li></p>
...
<p><li class="buttons" style="float:right;"><a href="agriculture3_post.php"><input  type="submit" value="POST" class="input_btn"/></a></li></p>
