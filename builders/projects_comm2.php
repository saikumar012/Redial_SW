...
<div class="main_hed">Bulk > Builders > Projects  > Residential > <span>Add Properties</span> <div class="inner_menu"><a href="projects2.php">Residential</a>|<a href="projects_comm.php" class="active">Commercial</a>|<a href="agriculture3.php">Agriculture</a></div></div>
...
<p><li><label style="width:150px;">Purpos type</label><br /><br /><input type="checkbox" name="" />Gated Community &nbsp; <input type="checkbox" name="" />Rental Purpose
</li></p>
...
<p><li class="buttons" style="float:right;"><a href="projects_comm2_post.php"><input  type="submit" value="POST" class="input_btn"/></a></li></p>
