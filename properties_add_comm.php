...
<select data-placeholder="Bed Rooms" class="chzn-select" tabindex="2" style="width:100px;">
          <option value=""></option> 
...
<p><li><label style="width:150px;">TRANSACTION TYPE <span class="star">*</span></label><br /><br /><input type="radio" name="TRANSACTIONTYPE" />New Property  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="TRANSACTIONTYPE" />Resale</li></p>
<p><li><label style="width:150px;">POSSESSION STATUS <span class="star">*</span></label><br /><br /><input type="radio" name="POSSESION" />Under Construction  <input type="radio" name="POSSESION" />Ready to Occupy</li></p>
...
<p><li><label>Are You <span class="star">*</span></label><input type="radio" name="areyou" />Owner &nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="areyou" />Agent &nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="areyou" />Builder</li></p>
...
</select> &nbsp;<input type="checkbox" /> Paid &nbsp;&nbsp;<input type="checkbox" /> Verified</li> 
...
<p><li class="buttons" style="float:right;"><a href="properties_addpost_comm.php"><input  type="submit" value="POST" class="input_btn"/></a></li></p>
