...
// Regular php code to submit form and other actions is written here
    ...
    if(isset($_POST['submit'])){
        ...
        $type = '2'; // remember 2 is for commercial, check in db for new value if needs to change.
...
//         .$paid.','.$verified.','.$assign.','.$property_id.','.$dateadded.','.$type.','.$expirydate.','.$addedby;
        $insert_query = "INSERT INTO `properties`
                            ...
                            `payment_type`, `paid`, `status`, `assignedto`, `property_id`, `dateadded`, `type`, `expirydate`,
                            `addedby`)
                     VALUES ('','$want','$property_type','$bedrooms','$area','$area_type','$price','$price_type','$city','$location',
                             '$description','$name','$phone','$email','$areyou','$auction','$gc','$rental','$tran_type',
                             '$possession_status','$customized','$plan','$months','$amount','$amount_type','$referrance','$payment_type',
                             '$paid','$verified','$assign','$property_id','$dateadded','$type','$expirydate','$addedby')";
        ...
        header("Location:properties_addpost_comm.php");
    ...
    <span style="float:right; font-size:11px; padding-top:3px;">&nbsp;&nbsp;&nbsp; <?php echo $session->username;  ?> &nbsp;&nbsp;|&nbsp;&nbsp; <a href="#">Logout</a></span>
    <div class="top_menu">
    ...
    <div style="width:100%; float:left;">
        ...
        <div class="main_hed" style="margin-top:9px;">List property > Properties > <span>Commercial</span> <div class="inner_menu"><a href="properties_add.php">Residential</a>|<a href="properties_add_comm.php" class="active">Commercial</a>|<a href="properties_add_ag.php" style="padding-right:0px;">Agriculture</a>
            </div></div>
            ...
            <form method="POST">
                <ol>
                    ...
                    <p><li><label>Property Type <span class="star">*</span></label>
                        ...
                        <select data-placeholder="Bed Rooms" id="bedrooms" name="bedrooms" class="chzn-select" tabindex="2" style="width:100px;">

                            <option value="0"></option>
                            <?php
                            $bedroomList = $database->getBedRooms();
                            while($bedroomRow = mysql_fetch_array($bedroomList)){ ?>
                                <option value="<?php echo $bedroomRow['id'] ?>"><?php echo $bedroomRow['bedrooms']; ?></option>
                            <?php } ?>
                        </select>
                    </li></p>
                    ...
                    <div class="special_cond" style="float:right; width:260px; margin-top:0px; margin-right:15px;">
                        ...
                        <p><li><input type="checkbox" id="gc" name="gc" /> GATED COMMUNITY</li></p>

                        <p><li><input type="checkbox" id="rental" name="rental" /> RENTAL PURPOSE</li></p>

                        <p><li><label style="width:150px;"> <span class="star">*</span>TRANSACTION TYPE</label><br /><br /><input type="radio" value="1" name="TRANSACTIONTYPE" />New Property  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" value="2" name="TRANSACTIONTYPE" />Resale</li></p>
                        <p><li><label style="width:150px;"> <span class="star">*</span>POSSESSION STATUS</label><br /><br /><input type="radio" value="1" name="POSSESION" />Under Construction  <input type="radio" value="2" name="POSSESION" />Ready to Occupy</li></p>
