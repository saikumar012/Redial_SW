...
<div class="main_hed" style="margin-top:0px;">Projects > Agriculture > Search List > <span>Search Result</span> <!--<div class="inner_menu"><a href="#" class="active">Residential</a>|<a href="#">Commercial</a>|<a href="#" style="padding-right:0px;">Agriculture</a>
</div>--></div>
...
<th scope="col">S No.</th><th scope="col">Project Id</th><th scope="col">Property Information</th><th scope="col">Subscription type</th><th scope="col">Status</th>
</tr>
...
<!--<div style="margin:15px 28px 0 0; float:right;"><a href="projects_search_result_sms.html"><input type="submit" value="Go" class="search_btn" name="Go"/></a></div>-->
