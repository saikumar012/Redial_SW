...
<div class="main_hed" style="margin-top:0px;">Projects > Agriculture > <span>Search List</span> <!--<div class="inner_menu"><a href="#" class="active">Residential</a>|<a href="#">Commercial</a>|<a href="#" style="padding-right:0px;">Agriculture</a>
</div>--></div>
...
<div class="search_results" style="margin-bottom:20px;">
...
<a href="projects_search_properties_ag.html"><img src="images/pr_view.png" style=" position:absolute; bottom:-25px; right:20px;" /></a>
...
<div style="margin:15px 28px 0 0; float:right;"><a href="projects_search_result_ag.html"><input type="submit" value="Go" class="search_btn" name="Go"/></a></div>
<p style="float:right; font-size:13px; margin-top:16px;">&nbsp; <input type="checkbox" /> 8 PJ &nbsp;&nbsp; <input type="checkbox" />12 PJ &nbsp;</p>
