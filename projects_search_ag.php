...
<a href="projects_search_properties_ag.php"><img src="images/pr_view.png" style=" position:absolute; bottom:-25px; right:20px;" /></a>
...
<div style="margin:15px 28px 0 0; float:right;"><a href="projects_search_result_ag.php"><input type="submit" value="Go" class="search_btn" name="Go"/></a></div>
