...
<div class="main_hed" style="margin-top:9px;">List property > Projects > Agriculture > <span>Projects List</span> <div class="inner_menu"><a href="projects_add.php">Residential</a>|<a href="projects_add_comm.php">Commercial</a>|<a href="projects_add_ag.php" style="padding-right:0px;" class="active">Agriculture</a>
</div></div>


    <div class="left_body">
        <?php
        $project_list=$database->getproject_list(3);
        while($row=mysql_fetch_array($project_list))
        {
            ...
            <div class="search_results" style="margin-bottom:25px;">
                ...
                <a href="projects_add2_ag.php?projectid=<?php echo $row['project_id']; ?>"><img src="images/pr_add.png" style=" position:absolute; bottom:-25px; right:70px;" /></a>
                <a href="projects_addpost2_ag.php?projectid=<?php echo $row['project_id']; ?>"><img src="images/pr_view.png" style=" position:absolute; bottom:-25px; right:20px;" /></a>
            </div>
        <?php } ?>
