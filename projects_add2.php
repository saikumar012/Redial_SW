...
if(!$session->logged_in){
    ...
    if(isset($_POST['submit']))
    {
      ...
      //  echo $insert_query;
        ...
        header("Location:projects_addpost2.php?projectid=".$property_id);
    }
?>
...
<div style="width:100%; float:left;" class="faqs">

<div class="main_hed" style="margin-top:9px;">List property > Projects > Residential > <span>Add Properties</span> <div class="inner_menu"><a href="projects_add.php" class="active">Residential</a>|<a href="projects_add_comm.php">Commercial</a>|<a href="projects_add_ag.php" style="padding-right:0px;">Agriculture</a>
</div></div>
