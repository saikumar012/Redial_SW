...
if(!$session->logged_in){
    ...
    if(isset($_POST['submit'])){
        ...
        $type = '3'; // remember 1 is for agriculture, check in db for new value if needs to change.
...
//         .$paid.','.$verified.','.$assign.','.$property_id.','.$dateadded.','.$type.','.$expirydate.','.$addedby;
        ...
        header("Location:properties_addpost_ag.php");
    }
?>
...
<div class="main_hed" style="margin-top:9px;">List property > Properties > <span>Agriculture</span> <div class="inner_menu"><a href="properties_add.php">Residential</a>|<a href="properties_add_comm.php">Commercial</a>|<a href="properties_add_ag.php" style="padding-right:0px;" class="active">Agriculture</a>
</div></div>
...
<p><li><label style="width:150px;">POSSESSION STATUS</label><br /><br /><input type="radio" name="POSSESION" />Under Construction  <input type="radio" name="POSSESION" />Ready to Occupy</li></p>-->
