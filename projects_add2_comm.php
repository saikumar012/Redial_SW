...
if(!$session->logged_in){
    ...
    if(isset($_POST['submit']))
    {
        ...
        header("Location:projects_addpost2_comm.php?projectid=".$property_id);
    }
...
<div class="main_hed" style="margin-top:9px;">List property > Projects > Commercial > <span>Add Properties</span> <div class="inner_menu"><a href="projects_add.php">Residential</a>|<a href="projects_add_comm.php" class="active">Commercial</a>|<a href="projects_add_ag.php" style="padding-right:0px;">Agriculture</a>
</div></div>
...
<div id="form" class="faqs">
    <form method="post">
        <ol>
            ...
            <a href="projects_addpost2_comm.php">
        </ol>
    </form>
</div>
