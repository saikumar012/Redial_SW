...
<div class="main_hed" style="margin-top:9px;">List property > Projects > <span>Commercial</span> <div class="inner_menu"><a href="projects_add.php">Residential</a>|<a href="projects_add_comm.php" class="active">Commercial</a>|<a href="projects_add_ag.php" style="padding-right:0px;">Agriculture</a>
</div></div>
...
<p><li class="buttons" style="float:right;"><a href="projects_addpost_comm.php"><input  type="submit" value="POST" class="input_btn"/></a></li></p>
