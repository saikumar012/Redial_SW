...
<div class="main_hed" style="margin-top:0px;">Properties > Residential > <span>Search List</span> <!--<div class="inner_menu"><a href="#" class="active">Residential</a>|<a href="#">Commercial</a>|<a href="#" style="padding-right:0px;">Agriculture</a>
</div>--></div>
...
<div style="margin:15px 28px 0 0; float:right;"><a href="properties_search_result.html"><input type="submit" value="Go" class="search_btn" name="Go"/></a> </div>
