...
<div class="main_hed" style="margin-top:9px;">List property > Projects > Residential > <span>Properties List</span> <div class="inner_menu"><a href="projects_add.php" class="active">Residential</a>|<a href="projects_add_comm.php">Commercial</a>|<a href="projects_add_ag.php" style="padding-right:0px;">Agriculture</a>
</div></div>


<div class="left_body">
    <?php
    $prop_id = $_GET['projectid'];
    $project_list=$database->getproject_listbyvariable($prop_id);
    while($row=mysql_fetch_array($project_list))
    {
        ...
        <div class="search_results" style="margin-bottom:25px;">
            ...
            <a href="projects_add2.php?projectid=<?php echo $row['project_id']; ?>"><img src="images/pr_add.png" style=" position:absolute; bottom:-25px; right:70px;" /></a>
        </div>
    <?php }?>
    <?php
    $prop_id = $_GET['projectid'];
    $project_list=$database->getsubproject_listbyvariable($prop_id);
    while($row1=mysql_fetch_array($project_list))
    {
        ?>
<div class="search_results">
<div style="position:absolute; right:0"><input type="checkbox" /></div>
<div class="div star2">***</div>
<div class="div userid"><?php echo $row1['project_id']; ?></div>
<a href="#history"><div class="div more">History</div></a>
<a href="#edit"><div class="div more">more</div></a>
...
<br /><br />
<div style="float:left;">
<div class="div propertytype"><?php echo $ptype=$database->getpropertyyvariable($row1['property_type']); ?></div>
<div class="div want"><?php if($row1['want']==1){echo "Sell";}else{echo "Rent";} ?></div>
<div class="div area"><?php echo $row1['area']; ?><?php echo $areatype=$database->getAreaTypeyvariable($row1['area_type']); ?></div>
</div>
<div style="float:left;">
    <div class="div requirment"><?php echo $row1['description']; ?></div>
<div class="div city"><?php echo $citylist=$database->getCitybyvariable($row1['city']); ?></div>
<div class="div whareincity"><?php echo $locationname=$database->getLoationbyvariable($row1['location']); ?></div>
</div>
<div style="float:left;">
<div class="div price"><?php echo $row1['price']; ?> <?php echo $pricetype=$database->getPricebyTypebyvariable($row1['price_type']); ?></div>
