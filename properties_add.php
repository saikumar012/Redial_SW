...
if(isset($_POST['submit'])){
    ...
    $type = '1'; // remember 1 is for residential, check in db for new value if needs to change.
...
//         .$paid.','.$verified.','.$assign.','.$property_id.','.$dateadded.','.$type.','.$expirydate.','.$addedby;
   ...
   // $insert_id = mysql_insert_id();
    ...
    header("Location:properties_addpost.php");
...
<div class="main_hed" style="margin-top:9px;">List property > Properties > <span>Residential</span> <div class="inner_menu"><a href="properties_add.php" class="active">Residential</a>|<a href="properties_add_comm.php">Commercial</a>|<a href="properties_add_ag.php" style="padding-right:0px;">Agriculture</a>
</div></div>
