...
<p><li><label style="width:150px;"> <span class="star">*</span>TRANSACTION TYPE</label><br /><br /><input type="radio" name="TRANSACTIONTYPE" />New Property  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="TRANSACTIONTYPE" />Resale</li></p>
<p><li><label style="width:150px;"> <span class="star">*</span>POSSESSION STATUS</label><br /><br /><input type="radio" name="POSSESION" />Under Construction  <input type="radio" name="POSSESION" />Ready to Occupy</li></p>
...
<p><li class="buttons" style="float:right;"><a href="properties_addpost.php"><input  type="submit" value="POST" class="input_btn"/></a></li></p>
